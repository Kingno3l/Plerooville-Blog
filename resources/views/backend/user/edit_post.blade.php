    ...
    @enderror
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $posts->post_name }}"
                                            name="post_name" placeholder="Enter city"
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $posts->post_slug }}" class="form-control"
                                            name="post_slug"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $posts->meta_title }}"
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $posts->post_yt_iframe }}"
                                            name="post_yt_iframe"
