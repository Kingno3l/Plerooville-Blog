                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('save.category') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="category_name"
                                            placeholder="Enter city" @error('category_name') is-invalid @enderror>
                                        @error('category_name')
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" name="navbar_status" id="checkCheckedNavbar">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" name="status" id="checkCheckedStatus">
