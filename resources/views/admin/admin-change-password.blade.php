                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.update.password')}}" class="forms-sample">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputUsername1" class="form-label">Previous Password</label>
                                    <input type="password" class="form-control" id="old_password" name="old_password" autocomplete="off" @error('old_password') is-invalid                          @enderror>
                                    @error('old_password')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="new_password" name="new_password" autocomplete="off" @error('new_password') is-invalid                          @enderror>
                                    @error('new_password')
                                        <span class="text-danger">{{ $message }}</span>    
                                    @enderror
                                </div>
